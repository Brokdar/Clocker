...
@pytest.mark.parametrize(
    "value,expected",
    [
        (timedelta(hours=8, minutes=30), '8:30:00'),
...
@pytest.mark.parametrize(
    "value,expected",
    [
        ('01.01.2022', date(2022, 1, 1)),
        ('11.10.2022', date(2022, 10, 11)),
...
@pytest.mark.parametrize(
    "value,expected",
    [
        ('8:00', timedelta(hours=8)),
        ('16:20', timedelta(hours=16, minutes=20)),
