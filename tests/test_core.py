...
@pytest.mark.parametrize("value,expected", [(time(8, 44, 32), time(8, 30)), (time(8, 11, 23), time(8, 0)),
...
@pytest.mark.parametrize("value,expected", [(time(8, 44, 32), time(8, 45)), (time(8, 11, 23), time(8, 15)),
                                            (time(17, 37, 23), time(17, 45)), (time(23, 50), time(0, 0)),
